...
<div class="section01 main-panel">
	...
	<div class="threebox">
        ...
        <div class="about-section text-center main-panel">
		<a name="About"></a>
...
<!--PORTFOLIO SECTION -->
	...
	<div class="portfolio-section text-center main-panel">
		<a name="Clients"></a>
...
<!--REFINE SECTION -->
	...
	<div class="refine-section text-center main-panel">
		<a name="Refine"></a>
...
<!--CONTACT SECTION -->
	...
	<div class="contact-section text-center main-panel">
		<a name="contact"></a>
